...
import { Bell, ChevronDown, CheckCircle2, Info, X, ArrowUpRight, Sun, Moon, Command } from "lucide-react"
  ...
  return (
    <header className="h-14 md:h-16 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between px-4 md:px-8 flex-shrink-0 relative z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="flex items-center gap-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
