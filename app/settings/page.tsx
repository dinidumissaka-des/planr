            ...
            <div className="bg-white dark:bg-[#0D1B2E] border border-gray-100 dark:border-white/8 rounded-2xl p-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                {!showDeleteConfirm ? (
                  ...
                  <div className="px-4 py-4 rounded-xl border border-red-200 dark:border-red-500/20 bg-red-50 dark:bg-red-500/8">
                    <p className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Delete your account?</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">This will permanently delete all your data including bookings, projects, and messages. This cannot be undone.</p>
                    ...
                    <Input
                      ...
                      placeholder="DELETE"
                      className="h-10 bg-white dark:bg-white/5 border-red-200 dark:border-red-500/20 dark:text-white text-sm rounded-xl mb-3"
                      autoFocus
                    />
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 h-9 bg-red-500 hover:bg-red-600 disabled:opacity-60 text-white text-sm font-semibold rounded-lg transition-colors"
                      >
